      ...
      <div class="row no-gutters">
        ...
        <div class="col-sm-4 align-self-center mt-5 p-0 bg-white">
          <div class="sign-in-from mt-5 bg-white">
            ...
            <p>Enter your username and password to access side panel.</p>
            <form class="mt-4 LoginFormIdentifier" method="POST" action="config/check_users.php">
              <div class="form-group">
                <label>Email address</label>
                <input type="text" class="form-control mb-0" name="usrname" id="usrname" placeholder="Enter email" autocomplete="no">
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Password</label>
                <input type="password" class="form-control mb-0" name="pssword" id="pssword" placeholder="Password" autocomplete="no">
                <input type="hidden" class="form-control mb-0" name="type_user" id="type_user" value="applicant">
              </div>
              <div class="d-inline-block w-100">
                <button type="submit" class="btn btn-primary float-right">Sign in</button>
              </div>
              <div class="sign-info">
                <span class="dark-color d-inline-block line-height-2">I have an account? <a href="index.php">Login Admin Panel</a></span>
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          // alert("Username or password is incorrect please check and try again !!")
            ...
            window.location.href = "pages/applicant-manage.php";
          }
        },
        error: function(e){
        //alert("Error: "+e);
